...
func = lambda evals: (lambda x: rpr.rp_uncert(x, rpr.RP14, evals=evals))
...
with open('exp_rp14_convergence.pkl', 'wb') as f:
...
with open('exp_rp14_repetitions.pkl', 'wb') as f:
...
#%% 4. Plot scatter results
# 1. Load from 'exp_rp_repetitions.pkl'
out = 0
n = len(IPSuS_repeats)
...
# Assuming RP22 is defined or imported in your environment
func = lambda evals: (lambda x: rpr.rp_uncert(x, rpr.RP22, evals=evals))
...
with open('exp_rp22_convergence.pkl', 'wb') as f:
    pickle.dump((p_F_list, info_list), f)
...
with open('exp_rp22_repetitions.pkl', 'wb') as f:
    pickle.dump(IPSuS_repeats, f)
...
# Assuming RP14 is defined or imported in your environment
func = lambda evals: (lambda x: rpr.rp_uncert(x, rpr.RP111, evals=evals))
...
with open('exp_rp111_convergence.pkl', 'wb') as f:
    pickle.dump((p_F_list, info_list), f)
